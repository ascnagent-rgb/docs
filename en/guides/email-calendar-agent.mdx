...
![Chat with task description — agent suggests Gmail, Calendar, Telegram](/images/en/18-guide-chat.png)
...
![Pasting rules in chat](/images/en/19-guide-identity.png)
...
![Agent confirms saved settings](/images/en/19-2-guide-user.png)
